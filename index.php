	...
	<body>
			...
			<div class="container-fluid">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="subscribe-form">
               	    	<div class="row form-section">
							...
							<div class="col-md-7 col-sm-7 col-xs-7">
			                      <input name="long_url" type="text" class="form-control" id="long_url" placeholder="Enter your URL to be shortened..." required/>
				  			</div>
							<div class="col-md-5 col-sm-5 col-xs-5">
								<button type="submit" name="shorten" class="tm-btn-subscribe">Shorten</button>
							</div>
				...
				<div class="footer-link">
					<p>Copyright © 2022 Thomas Hauser</p>
				</div>
			</div>	
	</body>
